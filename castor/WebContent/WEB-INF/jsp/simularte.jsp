...
<head>
  <meta charset="utf-8">
  <title>Simularte</title>

  <meta content="width=device-width, initial-scale=1.0" name="viewport">
  <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">

  <meta content="The Software Company" name="description">
  <meta content="Simularte Interactive Business" name="keywords">
...
<body class="menu-always-on-top">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-2">
          <a class="scroll site-logo" href="#promo-block"><img src="assets/frontend/onepage/img/logo/red.png" alt="Simularte"></a>
        </div>
        <!-- Logo END -->
          ...
          <li data-transition="fade" data-slotamount="5" data-masterspeed="700" data-delay="9400" class="slider-item-1">
            ...
            <div class="tp-caption large_text customin customout start"
              ...
              <div class="promo-like-text">
                <h2>Let's build with confidence</h2>
                <p>Get everyone working together, <br>easily connected in the <a href="javascript:void(0);">same place</a></p>
              </div>
            </div>
            <div class="tp-caption large_bold_white fade"
              ...
              style="z-index: 6">Simularte <span>The Construction App</span> Has Arrived
            </div>
          </li>
  ...
  <div class="col-md-8 col-sm-8 content" style="padding: 70px 0px 70px 0px;"> 
  <h3 style="font-size: 36px;font-weight: 200;text-align: center">Simularte's <a href="#" class="orange">construction app</a>
   provides users with a suite of project management tools to maximize collaboration and&nbsp;efficiency.</h3>
  </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-3 col-xs-12 item">
          ...
          <p>Eliminate potential delays and rework due to old versions of drawings and outdated information by housing all of you project information within one central location.</p>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-12 item">
          <i class="fa fa-tablet"></i>
          <h3>Increase Accessibility</h3>
          <p>Provide your entire office and field staff with the power to securely deliver real time, up-to-date project information to team members at any time.</p>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-12 item">
          <i class="fa fa-users"></i>
          <h3>Improve Visibility</h3>
          <p>In order for a job to be successful, teams need a transparent environment where everyone is held accountable for their work.</p>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-12 item">
          <i class="fa fa-comments"></i>
          <h3>Track Communications</h3>
          <p>Provide stakeholders with 24/7 visibility into project status and health. The ability to diagnose problems in real time and collaborate to resolve issues quickly.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="message-block content content-center valign-center" id="message-block">
    <div class="valign-center-elem">
      <h2 style="font-size: 24px">Built for general contractors, owners, <br>construction management firms, engineering firms and subcontractors, <br>We improve project communication and collaboration.<strong>Simularte</strong></h2>
  ...
  <div class="checkout-block content">
    <div class="container">
      <div class="row">
        <div class="col-md-10">
          <h2>CHECK OUT IT! <em>Most Full Featured &amp; Powerfull App</em></h2>
        </div>
        <div class="col-md-2 text-right">
          <a href="http://castor.elasticbeanstalk.com/toLogin" target="_blank" class="btn btn-primary">Live preview</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-6">
          <div class="copyright">2015 - Simularte. ALL Rights Reserved.</div>
        </div>
        <!-- END COPYRIGHT -->
        <!-- BEGIN SOCIAL ICONS -->
